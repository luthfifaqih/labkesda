                        ...
                        <div class="d-flex flex-wrap flex-sm-nowrap mb-3">
                            <div class="me-7 mb-4 d-flex align-items-center ">
                                <div
                                    ...
                                    <img src="{{ asset('frontend/assets/media/avatars/avatar.png') }}" alt="Avatar" />
                                </div>
                            </div>
                                ...
                                <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                    <div class="d-flex flex-column">
                                        <div class="d-flex align-items-center mb-2">
                                            <div class="fw-light text-dark -900 text-hover-info  fs-2 fw-bolder me-1">Hi,
                                                {{ Auth::user()->name }}
                                        ...
                                        <div class="mt-2 mb-2">
                                            ...
                                            <br />
                                            <span
                                                class="badge badge-light-info border border-info me-2 mb-3 fs-5">{{ Auth::user()->role }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-4">
                            ...
                            <a class="card bg-body-white hoverable card-xl-stretch mb-xl-8">
                                ...
                                <div class="card-body shadow" style="border-radius: 6px">
                                    <i class="ki-solid ki-profile-user fs-3x text-info"></i>
